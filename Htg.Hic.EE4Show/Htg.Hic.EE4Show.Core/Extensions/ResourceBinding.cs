...
namespace Htg.Hic.EE4Show.Core.Extensions;
...
public class ResourceBinding : MarkupExtension
{
	...
	{
		if (d is not FrameworkElement target || e.NewValue is not Tuple<object, DependencyProperty> newVal)
			return;
	...
	public override object ProvideValue(IServiceProvider serviceProvider)
	{
		...
		if (provideValueTargetService.TargetObject is not FrameworkElement targetObject || provideValueTargetService.TargetProperty is not DependencyProperty targetProperty)
			return null;
